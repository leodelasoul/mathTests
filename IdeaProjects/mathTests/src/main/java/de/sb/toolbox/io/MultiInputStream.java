...
/**
 * This class models filter-like input streams that are based on multiple byte sources. Reading from
 * such a source appears to be continuously reading one byte source after the other.
 */
