...
public class CallbackMap<E> extends AbstractMap<String,E>implements Map<String,E> {
	...
	public E remove (final Object key) {
		...
		final Entry<String,E> entry = new SimpleEntry<>((String) key, this.delegateMap.get(key));
	...
	private final class CallbackEntrySet extends AbstractSet<Entry<String,E>> {
		...
		public boolean remove (final Object object) {
			...
			final Entry<String,E> entry = (Entry<String,E>) object;
		 ...
		 */
		private final class CallbackEntrySetIterator implements Iterator<Entry<String,E>> {
			private final Iterator<Entry<String,E>> iterator = CallbackMap.this.delegateMap.entrySet().iterator();
			private Entry<String,E> currentEntry = null;
