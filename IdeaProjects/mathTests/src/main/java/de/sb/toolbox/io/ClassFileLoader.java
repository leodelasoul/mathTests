...
/**
 * Class loader extending it's parent class loader by reading class files from a given context
 * directory.
 */
...
public class ClassFileLoader extends ClassLoader {
	 ...
	 * class files within the given context directory or one of it's children.
