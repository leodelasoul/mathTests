...
/**
 * This class models filter-like output streams that are based on multiple data sinks. Writing into
 * such a stream means writing into multiple streams at once.
 */
