...
public final class Lists {
	...
	/**
	 * Adds an element to the given list at a random position. Note that this operation is not
	 * thread safe when used with a list that is shared between multiple threads.
	 * @param list the list
	 ...
	 * @throws IllegalArgumentException if a property of the specified element prevents it from
	 *         being added
	 */
	...
	/**
	 * Adds an element to the given list at position zero. Note that this operation is not thread
	 * safe when used with a list that is shared between multiple threads.
	 * @param list the list
	 * @param element the element to be added
	 * @throws NullPointerException if any of the given arguments is {@code null}
	 * @throws UnsupportedOperationException if the add operation is not supported by the given list
	...
	/**
	 * Returns the first element from the given list. Note that this operation is not thread safe
	...
	/**
	 * Returns the last element from the given list. Note that this operation is not thread safe
	 * when used with a list that is shared between multiple threads.
	 * @param list the list
	 * @return the element
	 * @throws NullPointerException if the given list is {@code null}
	...
	/**
	 * Returns a random element from the given list. Note that this operation is not thread safe
	 * when used with a list that is shared between multiple threads.
	 * @param list the list
	 * @return the element
	 * @throws NullPointerException if the given list is {@code null}
	...
	/**
	 * Removes the first element from the given list and returns it. Note that this operation is not
	 * thread safe when used with a list that is shared between multiple threads.
	 * @param list the list
	...
	/**
	 * Removes the last element from the given list and returns it. Note that this operation is not
	 * thread safe when used with a list that is shared between multiple threads.
	 * @param list the list
	 * @return the element that has been removed
	 * @throws NullPointerException if the given list is {@code null}
	...
	/**
	 * Removes an element from the given list at a random position and returns it. Note that this
	 * operation is not thread safe when used with a list that is shared between multiple threads.
	 * @param list the list
	 * @return the element that has been removed
	 * @throws NullPointerException if the given list is {@code null}
	 * @throws UnsupportedOperationException if element removal is not supported by the given list
