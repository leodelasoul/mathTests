...
public interface HttpCredentials {
	...
	/**
	 * Instances model immutable RFC 2617 {@code HTTP Basic} authentication 
	 * credentials consisting of username and password.
	 */
	...
	/**
	 * Instances model immutable RFC 2617 {@code HTTP Digest} authentication
	 * credentials consisting of username, uri, response, etc.
	 */
	class Digest implements HttpCredentials {
		...
		public boolean equals (final Object object) {
			...
			return Objects.equals(this.response, credentials.response)
				&& Objects.equals(this.username, credentials.username)
				&& Objects.equals(this.realm, credentials.realm)
				&& Objects.equals(this.uri, credentials.uri)
				&& Objects.equals(this.nonce, credentials.nonce);
		}
